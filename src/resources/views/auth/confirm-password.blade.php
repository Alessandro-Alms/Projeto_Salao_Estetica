...
<body class="font-body antialiased relative min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-title text-[#1A002B]">Área segura</h1>
            <p class="text-[#4A00B9] mt-2">Confirme sua senha para continuar ✧</p>
        </div>
        ...
        <div class="glass-card rounded-2xl p-8 shadow-xl">
            ...
            <div class="mb-6 text-sm text-gray-600 bg-white/50 rounded-lg p-3 text-center">
                <i class="fa-solid fa-shield-hooded text-[#7B19E5] mr-2"></i>
