...
<head>
    ...
    <title>Cheias de Charme - Recuperar senha</title>
...
<body class="font-body antialiased relative min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-title text-[#1A002B]">Recuperar senha</h1>
            <p class="text-[#4A00B9] mt-2">Te enviamos um link para redefinir ✧</p>
        </div>

        <!-- Card de recuperação -->
        <div class="glass-card rounded-2xl p-8 shadow-xl">
            <!-- Mensagem de instrução -->
            <div class="mb-6 text-sm text-gray-600 bg-white/50 rounded-lg p-3 text-center">
                Esqueceu sua senha? Sem problemas. <br>
                Informe seu e-mail e enviaremos um link para redefinição.
            </div>

            <!-- Session Status (mensagem de sucesso) -->
            @if (session('status'))
